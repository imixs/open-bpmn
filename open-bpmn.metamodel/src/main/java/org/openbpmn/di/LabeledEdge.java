 ...
 * </p>
 * <ul>
 *   <li>{@link org.openbpmn.di.LabeledEdge#getOwnedLabel <em>Owned Label</em>}</li>
 * </ul>
 *
 * @see org.openbpmn.di.DiPackage#getLabeledEdge()
 * @model abstract="true"
 * @generated
 */
public interface LabeledEdge extends Edge {
     ...
     * @see org.openbpmn.di.DiPackage#getLabeledEdge_OwnedLabel()
