 ...
 * </p>
 * <ul>
 *   <li>{@link org.imixs.bpmn2.impl.IncusiveGatewayImpl#getDefaultSequenceFlow <em>Default Sequence Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IncusiveGatewayImpl extends GatewayImpl implements IncusiveGateway {
    ...
    protected EClass eStaticClass() {
        return Bpmn2Package.Literals.INCUSIVE_GATEWAY;
    }
    ...
    public void setDefaultSequenceFlow(SequenceFlow newDefaultSequenceFlow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.INCUSIVE_GATEWAY__DEFAULT_SEQUENCE_FLOW, oldDefaultSequenceFlow, defaultSequenceFlow));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Bpmn2Package.INCUSIVE_GATEWAY__DEFAULT_SEQUENCE_FLOW:
