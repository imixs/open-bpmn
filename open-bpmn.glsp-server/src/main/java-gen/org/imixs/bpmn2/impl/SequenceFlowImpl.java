 ...
 * </p>
 * <ul>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getSize <em>Size</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getEdgePlacement <em>Edge Placement</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getLayoutOptions <em>Layout Options</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getConditionExpression <em>Condition Expression</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link org.imixs.bpmn2.impl.SequenceFlowImpl#getTargetRef <em>Target Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceFlowImpl extends GEdgeImpl implements SequenceFlow {
    ...
    public NotificationChain basicSetPosition(GPoint newPosition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__POSITION, oldPosition, newPosition);
    ...
    public void setPosition(GPoint newPosition) {
        if (newPosition != position) {
            ...
            if (position != null)
                msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.SEQUENCE_FLOW__POSITION, null, msgs);
            if (newPosition != null)
                msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.SEQUENCE_FLOW__POSITION, null, msgs);
            msgs = basicSetPosition(newPosition, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__POSITION, newPosition, newPosition));
    }
    ...
    public NotificationChain basicSetSize(GDimension newSize, NotificationChain msgs) {
        ...
        size = newSize;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__SIZE, oldSize, newSize);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setSize(GDimension newSize) {
        if (newSize != size) {
            NotificationChain msgs = null;
            if (size != null)
                msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.SEQUENCE_FLOW__SIZE, null, msgs);
            if (newSize != null)
                msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.SEQUENCE_FLOW__SIZE, null, msgs);
            msgs = basicSetSize(newSize, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__SIZE, newSize, newSize));
    }
    ...
    public NotificationChain basicSetEdgePlacement(GEdgePlacement newEdgePlacement, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__EDGE_PLACEMENT, oldEdgePlacement, newEdgePlacement);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setEdgePlacement(GEdgePlacement newEdgePlacement) {
        if (newEdgePlacement != edgePlacement) {
            ...
            if (edgePlacement != null)
                msgs = ((InternalEObject)edgePlacement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.SEQUENCE_FLOW__EDGE_PLACEMENT, null, msgs);
            if (newEdgePlacement != null)
                msgs = ((InternalEObject)newEdgePlacement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bpmn2Package.SEQUENCE_FLOW__EDGE_PLACEMENT, null, msgs);
            msgs = basicSetEdgePlacement(newEdgePlacement, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__EDGE_PLACEMENT, newEdgePlacement, newEdgePlacement));
    }
    ...
    public void setLayout(String newLayout) {
        ...
        layout = newLayout;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__LAYOUT, oldLayout, layout));
    }
    ...
    public EMap<String, Object> getLayoutOptions() {
        if (layoutOptions == null) {
            layoutOptions = new EcoreEMap<String,Object>(GraphPackage.Literals.STRING_TO_OBJECT_MAP_ENTRY, StringToObjectMapEntryImpl.class, this, Bpmn2Package.SEQUENCE_FLOW__LAYOUT_OPTIONS);
        }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__NAME, oldName, name));
    }
    ...
    public void setDocumentation(String newDocumentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.SEQUENCE_FLOW__DOCUMENTATION, oldDocumentation, documentation));
    }
    ...
    public EList<String> getCategory() {
        if (category == null) {
            category = new EDataTypeUniqueEList<String>(String.class, this, Bpmn2Package.SEQUENCE_FLOW__CATEGORY);
        }
        return category;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Bpmn2Package.SEQUENCE_FLOW__POSITION:
                return basicSetPosition(null, msgs);
            case Bpmn2Package.SEQUENCE_FLOW__SIZE:
                return basicSetSize(null, msgs);
            case Bpmn2Package.SEQUENCE_FLOW__EDGE_PLACEMENT:
                return basicSetEdgePlacement(null, msgs);
            case Bpmn2Package.SEQUENCE_FLOW__LAYOUT_OPTIONS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case Bpmn2Package.SEQUENCE_FLOW__LAYOUT:
                return getLayout();
            case Bpmn2Package.SEQUENCE_FLOW__LAYOUT_OPTIONS:
                if (coreType) return getLayoutOptions();
                else return getLayoutOptions().map();
            case Bpmn2Package.SEQUENCE_FLOW__NAME:
                return getName();
            case Bpmn2Package.SEQUENCE_FLOW__DOCUMENTATION:
                return getDocumentation();
            case Bpmn2Package.SEQUENCE_FLOW__CATEGORY:
                return getCategory();
            case Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == GBoundsAware.class) {
            switch (derivedFeatureID) {
                case Bpmn2Package.SEQUENCE_FLOW__POSITION: return GraphPackage.GBOUNDS_AWARE__POSITION;
                case Bpmn2Package.SEQUENCE_FLOW__SIZE: return GraphPackage.GBOUNDS_AWARE__SIZE;
                default: return -1;
            }
        }
        ...
        if (baseClass == GEdgeLayoutable.class) {
            switch (derivedFeatureID) {
                case Bpmn2Package.SEQUENCE_FLOW__EDGE_PLACEMENT: return GraphPackage.GEDGE_LAYOUTABLE__EDGE_PLACEMENT;
                default: return -1;
            }
        }
        if (baseClass == GLayouting.class) {
            switch (derivedFeatureID) {
                case Bpmn2Package.SEQUENCE_FLOW__LAYOUT: return GraphPackage.GLAYOUTING__LAYOUT;
                case Bpmn2Package.SEQUENCE_FLOW__LAYOUT_OPTIONS: return GraphPackage.GLAYOUTING__LAYOUT_OPTIONS;
                default: return -1;
            }
        }
        ...
        if (baseClass == BaseElement.class) {
            switch (derivedFeatureID) {
                case Bpmn2Package.SEQUENCE_FLOW__NAME: return Bpmn2Package.BASE_ELEMENT__NAME;
                case Bpmn2Package.SEQUENCE_FLOW__DOCUMENTATION: return Bpmn2Package.BASE_ELEMENT__DOCUMENTATION;
                default: return -1;
            }
        }
        if (baseClass == FlowElement.class) {
            switch (derivedFeatureID) {
                case Bpmn2Package.SEQUENCE_FLOW__CATEGORY: return Bpmn2Package.FLOW_ELEMENT__CATEGORY;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == GBoundsAware.class) {
            switch (baseFeatureID) {
                case GraphPackage.GBOUNDS_AWARE__POSITION: return Bpmn2Package.SEQUENCE_FLOW__POSITION;
                case GraphPackage.GBOUNDS_AWARE__SIZE: return Bpmn2Package.SEQUENCE_FLOW__SIZE;
                default: return -1;
            }
        }
        if (baseClass == GShapeElement.class) {
        ...
        if (baseClass == GEdgeLayoutable.class) {
            switch (baseFeatureID) {
                case GraphPackage.GEDGE_LAYOUTABLE__EDGE_PLACEMENT: return Bpmn2Package.SEQUENCE_FLOW__EDGE_PLACEMENT;
                default: return -1;
            }
        }
        if (baseClass == GLayouting.class) {
            switch (baseFeatureID) {
                case GraphPackage.GLAYOUTING__LAYOUT: return Bpmn2Package.SEQUENCE_FLOW__LAYOUT;
                case GraphPackage.GLAYOUTING__LAYOUT_OPTIONS: return Bpmn2Package.SEQUENCE_FLOW__LAYOUT_OPTIONS;
                default: return -1;
            }
        }
        if (baseClass == GNode.class) {
        ...
        if (baseClass == BaseElement.class) {
            switch (baseFeatureID) {
                case Bpmn2Package.BASE_ELEMENT__NAME: return Bpmn2Package.SEQUENCE_FLOW__NAME;
                case Bpmn2Package.BASE_ELEMENT__DOCUMENTATION: return Bpmn2Package.SEQUENCE_FLOW__DOCUMENTATION;
                default: return -1;
            }
        }
        if (baseClass == FlowElement.class) {
            switch (baseFeatureID) {
                case Bpmn2Package.FLOW_ELEMENT__CATEGORY: return Bpmn2Package.SEQUENCE_FLOW__CATEGORY;
                default: return -1;
            }
        }
