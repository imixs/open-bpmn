 ...
 * </p>
 * <ul>
 *   <li>{@link org.imixs.bpmn2.impl.ExclusiveGatewayImpl#getDefaultSequenceFlow <em>Default Sequence Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExclusiveGatewayImpl extends GatewayImpl implements ExclusiveGateway {
    ...
    public void setDefaultSequenceFlow(SequenceFlow newDefaultSequenceFlow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.EXCLUSIVE_GATEWAY__DEFAULT_SEQUENCE_FLOW, oldDefaultSequenceFlow, defaultSequenceFlow));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Bpmn2Package.EXCLUSIVE_GATEWAY__DEFAULT_SEQUENCE_FLOW:
