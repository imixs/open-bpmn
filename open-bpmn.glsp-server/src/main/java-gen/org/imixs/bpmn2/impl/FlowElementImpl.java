 ...
 * </p>
 * <ul>
 *   <li>{@link org.imixs.bpmn2.impl.FlowElementImpl#getCategory <em>Category</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FlowElementImpl extends BaseElementImpl implements FlowElement {
    ...
    public EList<String> getCategory() {
        if (category == null) {
            category = new EDataTypeUniqueEList<String>(String.class, this, Bpmn2Package.FLOW_ELEMENT__CATEGORY);
        }
        return category;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Bpmn2Package.FLOW_ELEMENT__CATEGORY:
                return getCategory();
        }
