...
public class BpmngraphSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case BpmngraphPackage.EXPRESSION: {
            ...
            case BpmngraphPackage.FLOW_NODE: {
            ...
            case BpmngraphPackage.PARALLEL_GATEWAY: {
            ...
            case BpmngraphPackage.EXCLUSIVE_GATEWAY: {
            ...
            case BpmngraphPackage.INCUSIVE_GATEWAY: {
            ...
            case BpmngraphPackage.COMPLEX_GATEWAY: {
            ...
            case BpmngraphPackage.CATCH_EVENT: {
            ...
            case BpmngraphPackage.THROW_EVENT: {
            ...
            case BpmngraphPackage.ACTIVITY: {
