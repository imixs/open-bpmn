 ...
 * </p>
 * <ul>
 *   <li>{@link org.imixs.bpmn.bpmngraph.impl.ComplexGatewayImpl#getDefaultSequenceFlow <em>Default Sequence Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexGatewayImpl extends GatewayImpl implements ComplexGateway {
    ...
    protected EClass eStaticClass() {
        return BpmngraphPackage.Literals.COMPLEX_GATEWAY;
    }
    ...
    public void setDefaultSequenceFlow(SequenceFlow newDefaultSequenceFlow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BpmngraphPackage.COMPLEX_GATEWAY__DEFAULT_SEQUENCE_FLOW, oldDefaultSequenceFlow, defaultSequenceFlow));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case BpmngraphPackage.COMPLEX_GATEWAY__DEFAULT_SEQUENCE_FLOW:
