...
public interface BpmnPackage extends EPackage {
    ...
    /**
	 * The meta object id for the '{@link org.openbpmn.glsp.bpmn.impl.DataStoreGNodeImpl <em>Data Store GNode</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.openbpmn.glsp.bpmn.impl.DataStoreGNodeImpl
	 * @see org.openbpmn.glsp.bpmn.impl.BpmnPackageImpl#getDataStoreGNode()
	 * @generated
	 */
	int DATA_STORE_GNODE = 8;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__ARGS = BPMNG_NODE__ARGS;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__ID = BPMNG_NODE__ID;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__CSS_CLASSES = BPMNG_NODE__CSS_CLASSES;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__CHILDREN = BPMNG_NODE__CHILDREN;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__PARENT = BPMNG_NODE__PARENT;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__TRACE = BPMNG_NODE__TRACE;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__TYPE = BPMNG_NODE__TYPE;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__POSITION = BPMNG_NODE__POSITION;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__SIZE = BPMNG_NODE__SIZE;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__EDGE_PLACEMENT = BPMNG_NODE__EDGE_PLACEMENT;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__LAYOUT = BPMNG_NODE__LAYOUT;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__LAYOUT_OPTIONS = BPMNG_NODE__LAYOUT_OPTIONS;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__NAME = BPMNG_NODE__NAME;
	 ...
	 * @ordered
	 */
	int DATA_STORE_GNODE__KIND = BPMNG_NODE__KIND;

				/**
	 * The number of structural features of the '<em>Data Store GNode</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DATA_STORE_GNODE_FEATURE_COUNT = BPMNG_NODE_FEATURE_COUNT + 0;

				/**
	 * The number of operations of the '<em>Data Store GNode</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DATA_STORE_GNODE_OPERATION_COUNT = BPMNG_NODE_OPERATION_COUNT + 0;
    ...
    /**
	 * Returns the meta object for class '{@link org.openbpmn.glsp.bpmn.DataStoreGNode <em>Data Store GNode</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Data Store GNode</em>'.
	 * @see org.openbpmn.glsp.bpmn.DataStoreGNode
	 * @generated
	 */
	EClass getDataStoreGNode();
    ...
    interface Literals {
        ...
        /**
		 * The meta object literal for the '{@link org.openbpmn.glsp.bpmn.impl.DataStoreGNodeImpl <em>Data Store GNode</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.openbpmn.glsp.bpmn.impl.DataStoreGNodeImpl
		 * @see org.openbpmn.glsp.bpmn.impl.BpmnPackageImpl#getDataStoreGNode()
		 * @generated
		 */
		EClass DATA_STORE_GNODE = eINSTANCE.getDataStoreGNode();
