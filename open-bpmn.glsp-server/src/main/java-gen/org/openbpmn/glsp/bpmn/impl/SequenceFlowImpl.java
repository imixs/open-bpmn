...
public class SequenceFlowImpl extends GEdgeImpl implements SequenceFlow {
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BpmnPackage.SEQUENCE_FLOW__NAME, oldName, name));
    }
    ...
    public void setCondition(String newCondition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BpmnPackage.SEQUENCE_FLOW__CONDITION, oldCondition, condition));
    }
    ...
    public void setDefaultFlow(boolean newDefaultFlow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BpmnPackage.SEQUENCE_FLOW__DEFAULT_FLOW, oldDefaultFlow, defaultFlow));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case BpmnPackage.SEQUENCE_FLOW__NAME:
                return getName();
            case BpmnPackage.SEQUENCE_FLOW__CONDITION:
                return getCondition();
            case BpmnPackage.SEQUENCE_FLOW__DEFAULT_FLOW:
