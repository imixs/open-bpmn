...
import org.imixs.bpmn.emf.ActivityNode;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.imixs.bpmn.emf.impl.ActivityNodeImpl#getNodeType <em>Node Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityNodeImpl extends GNodeImpl implements ActivityNode {
	...
	protected EClass eStaticClass() {
		return Bpmn2Package.Literals.ACTIVITY_NODE;
	}
	...
	public void setNodeType(String newNodeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.ACTIVITY_NODE__NODE_TYPE, oldNodeType, nodeType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bpmn2Package.ACTIVITY_NODE__NODE_TYPE:
				return getNodeType();
		}
