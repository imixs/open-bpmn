 ...
 * </p>
 * <ul>
 *   <li>{@link org.imixs.emf.bpmn2.impl.WeightedEdgeImpl#getProbability <em>Probability</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeightedEdgeImpl extends GEdgeImpl implements WeightedEdge {
	...
	protected EClass eStaticClass() {
		return Bpmn2Package.Literals.WEIGHTED_EDGE;
	}
	...
	public void setProbability(String newProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.WEIGHTED_EDGE__PROBABILITY, oldProbability, probability));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bpmn2Package.WEIGHTED_EDGE__PROBABILITY:
